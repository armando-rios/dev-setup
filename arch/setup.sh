...
install_packages() {
  ...
  sudo pacman -S --needed --noconfirm git base-devel nvm neovim ripgrep fzf gcc waybar hyprpaper hyprsunset swaync zsh ghostty ttf-jetbrains-mono-nerd discord lazygit steam
}
